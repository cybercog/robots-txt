...
We are trying to keep backwards compatibility breaks in RobotsTxt to an absolute minimum. Please take this into account when proposing changes.
...
- [General problems](https://github.com/cybercog/robots-txt/issues)
